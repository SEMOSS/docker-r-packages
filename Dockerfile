#docker build . -t quay.io/semoss/docker-r-packages:R4.1.2-debian10
...
ARG BUILDER_BASE_TAG=R4.1.2-debian10-builder

FROM ${BASE_REGISTRY}/${BASE_IMAGE}:${BASE_TAG} as basegit
...
RUN apt-get update \
	...
	&& wget https://www.rforge.net/Rserve/snapshot/Rserve_1.8-10.tar.gz \
